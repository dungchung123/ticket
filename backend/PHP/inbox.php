    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">e19c4035@gmail.com</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="account-dropdown__footer">
                                                <a href="http://localhost/php/ticket/backend/php/login.php">
            ...
            <div class="main-content">
               <!-- header -->
               <div class="text-center"><h2>Slide</h2></div>
               <table class="table table-striped">
                  ...
                  <tbody>
                     <?
                        $sql="select *from Slide_Herder";
                        $Slide_Herder=executeResult($sql);
                        $stt=0;
                     ?>
                     <?
                     foreach ($Slide_Herder as $item) {
                        echo'
                            <tr>
               ...
               <div class="container-fluid">
                   <div class="row">
                       <div class="col-md-12">
                           <div class="text-center"><h1>nav</h1></div>
                       </div>
                   </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="#" class="list-group-item list-group-item-action ">
                                <em style="padding-right: 4em;">1</em>
                                <em>a</em>
                                <button type="button" class="btn btn-light"style="float: right;">Light</button>
                                <button type="button" class="btn btn-dark" style="float: right;">Dark</button>
                            </a>    
                            <a href="#" class="list-group-item list-group-item-action ">
                                <em style="padding-right: 4em;">1</em>
                                <em>a</em>
               ...
               <!-- CONTAINER -->
                <div class="container thumbnail-movie">
                        <div class="text-center"style="margin: 1em;"><h2>thumbnail</h2></div>
                            <div class="row">
                                <?php 
                                $sql="select * from Movie";
                                $Moveilist= executeResult($sql);
